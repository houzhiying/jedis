...
public class Jedis extends BinaryJedis implements JedisCommands, MultiKeyCommands,
   ...
   * contains a String value "list" if the key contains a List value "set" if the key contains a Set
   * value "zset" if the key contains a Sorted Set value "hash" if the key contains a Hash value
   */
  ...
  public Long hsetex(final String key, final long expire, final String field, final String value) {
    checkIsInMultiOrPipeline();
    client.hsetex(key, expire, field, value);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long hexpire(final String key, final int expire) {
    checkIsInMultiOrPipeline();
    client.hexpire(key, expire);
    return client.getIntegerReply();
  }

  @Override
  public Long httl(final String key) {
    checkIsInMultiOrPipeline();
    client.httl(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long hpersist(final String key) {
    checkIsInMultiOrPipeline();
    client.hpersist(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long lexpire(final String key, final int expire) {
    checkIsInMultiOrPipeline();
    client.lexpire(key, expire);
    return client.getIntegerReply();
  }

  @Override
  public Long lttl(String key) {
    checkIsInMultiOrPipeline();
    client.lttl(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long lpersist(String key) {
    checkIsInMultiOrPipeline();
    client.lpersist(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long sclear(final String key) {
    checkIsInMultiOrPipeline();
    client.sclear(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long smclear(final String... key) {
    checkIsInMultiOrPipeline();
    client.smclear(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long sexpire(final String key, final int expire) {
    checkIsInMultiOrPipeline();
    client.sexpire(key, expire);
    return client.getIntegerReply();
  }

  @Override
  public Long sttl(final String key) {
    checkIsInMultiOrPipeline();
    client.sttl(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long spersist(final String key) {
    checkIsInMultiOrPipeline();
    client.spersist(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long zclear(final String key) {
    checkIsInMultiOrPipeline();
    client.zclear(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long zexpire(final String key, final int expire) {
    checkIsInMultiOrPipeline();
    client.zexpire(key, expire);
    return client.getIntegerReply();
  }

  @Override
  public Long zttl(final String key) {
    checkIsInMultiOrPipeline();
    client.zttl(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long zpersist(final String key) {
    checkIsInMultiOrPipeline();
    client.zpersist(key);
    return client.getIntegerReply();
  }
   ...
   * operation timed out, the return value is a nil multi bulk reply. Most client values will return
  ...
  @Override
  public String jset(final String key, final Path path, final String value) {
    checkIsInMultiOrPipeline();
    client.jset(key, getSingleOptionalPath(path), value);
    return client.getStatusCodeReply();
  }

  @Override
  public List<String> jget(final String key, final Path path) {
    checkIsInMultiOrPipeline();
    client.jget(key, getSingleOptionalPath(path));
    return client.getMultiBulkReply();
  }

  @Override
  public Long jexists(final String... key) {
    checkIsInMultiOrPipeline();
    client.jexists(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Boolean jexists(final String key) {
    checkIsInMultiOrPipeline();
    client.jexists(key);
    return client.getIntegerReply() == 1;
  }
  ...
  @Override
  public Long jdel(final String key, final Path path) {
    checkIsInMultiOrPipeline();
    client.jdel(key, getSingleOptionalPath(path));
    return client.getIntegerReply();
  }

  @Override
  public List<String> jmkget(final String... key) {
    checkIsInMultiOrPipeline();
    client.jmkget(key);
    return client.getMultiBulkReply();
  }
  ...
  @Override
  public String jtype(final String key, final Path path) {
    checkIsInMultiOrPipeline();
    client.jtype(key, getSingleOptionalPath(path));
    return client.getStatusCodeReply();
  }

  @Override
  public Long jobjlen(final String key) {
    checkIsInMultiOrPipeline();
    client.jobjlen(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public Long jarrappend(final String key, final Path path, final String value) {
    checkIsInMultiOrPipeline();
    client.jarrappend(key, getSingleOptionalPath(path), value);
    return client.getIntegerReply();
  }

  @Override
  public Long jarrlen(final String key) {
    checkIsInMultiOrPipeline();
    client.jarrlen(key);
    return client.getIntegerReply();
  }
  ...
  @Override
  public String jarrpop(final String key) {
    checkIsInMultiOrPipeline();
    client.jarrpop(key);
    return client.getStatusCodeReply();
  }

  public static Path getSingleOptionalPath(Path... path) {
