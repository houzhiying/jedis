...
public final class Protocol {
    ...
    public static void sendCommand(final RedisOutputStream os, final JsonCommand command,
                                   final byte[]... args) {
        sendCommand(os, command.raw, args);
    }
    ...
    public static enum JsonCommand {
        GET("JSON.GET"),
        SET("JSON.SET"),
        DEL("JSON.DEL"),
        TYPE("JSON.TYPE"),
        EXISTS("JSON.KEYEXISTS"),
        MKGET("JSON.MKGET"),
        ARRLEN("JSON.ARRLEN"),
        OBJLEN("JSON.OBJLEN"),
