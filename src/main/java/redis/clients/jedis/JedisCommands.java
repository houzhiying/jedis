...
public interface JedisCommands {
  ...
  Long hexpire(String key, int expire);

  Long httl(String key);

  Long hpersist(String key);
  ...
  Long lclear(String key);

  Long lexpire(String key, int expire);

  Long lttl(String key);

  Long lpersist(String key);
  ...
  Long sclear(String key);

  Long smclear(String... key);

  Long sexpire(String key, int expire);

  Long sttl(String key);

  Long spersist(String key);
  ...
  Long zclear(String key);

  Long zexpire(String key, int expire);

  Long zttl(String key);

  Long zpersist(String key);
  ...
  String jset(String key, Path path, String value);

  List<String> jget(String key, Path path);

  Long jexists(String... key);

  Boolean jexists(String key);

  Long jdel(String key, Path path);

  List<String> jmkget(String... key);

  String jtype(String key, Path path);

  Long jobjlen(String key);

  Long jarrappend(String key, Path path, String value);

  Long jarrlen(String key);

  String jarrpop(String key);
}
